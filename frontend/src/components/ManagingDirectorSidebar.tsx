...
export default function ManagingDirectorSidebar() {
    ...
    const menuItems = [
        ...
        { label: 'View Requests (Staff)', href: `${basePath}/view-requests`, icon: FaUsers },
        { label: 'Messages to GS', href: `${basePath}/messages-gs`, icon: FaBuilding },
        { label: 'Messages to AC', href: `${basePath}/messages-ac`, icon: FaEnvelope },
        { label: 'Messages to Chief', href: `${basePath}/messages-chief`, icon: FaCrown },
        { label: 'Approve & Send (GS)', href: `${basePath}/approve-decisions-gs`, icon: FaCheckDouble },
        { label: 'Request Chief (AC Dec)', href: `${basePath}/request-chief-ac`, icon: FaPaperPlane },
        { label: 'View AC Decisions', href: `${basePath}/view-ac-decisions`, icon: FaClipboardCheck },
        { label: 'Request to GS', href: `${basePath}/request-material`, icon: FaUserTie },
            ...
            `}>
                <div className="w-72 flex flex-col h-full flex-shrink-0">
                    ...
                    <div className="p-6 border-b border-slate-800/50 flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-blue-600 flex items-center justify-center shadow-lg shadow-indigo-500/20 text-white">
                            <FaCrown className="text-xl" />
                        </div>
                        <div>
                            <h2 className="text-lg font-bold text-white tracking-tight">Managing Dir</h2>
                            <p className="text-xs font-medium text-indigo-400 uppercase tracking-wider">Executive</p>
                        </div>
                    </div>
                    ...
                    <div className="p-4 border-t border-slate-800/50 bg-slate-950/50 backdrop-blur-sm">
                        <div className="flex items-center gap-3 rounded-lg p-2 hover:bg-slate-900 transition-colors cursor-pointer">
                            ...
                            <div className="overflow-hidden">
                                <p className="text-sm font-medium text-white truncate">Managing Dir</p>
                                <p className="text-xs text-slate-500 truncate">director@system</p>
                            </div>
                        </div>
                    </div>
                </div>
