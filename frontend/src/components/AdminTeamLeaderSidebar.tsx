...
export default function AdminTeamLeaderSidebar() {
    ...
    const menuItems = [
        ...
        { label: 'View Requests (Empl)', href: `${basePath}/view-requests`, icon: FaUsers },
        { label: 'Messages to MD', href: `${basePath}/messages-md`, icon: FaEnvelope },
        { label: 'Approve & Send (MD)', href: `${basePath}/approve-decisions`, icon: FaCheckDouble },
            ...
            `}>
                <div className="w-72 flex flex-col h-full flex-shrink-0">
                    ...
                    <div className="p-6 border-b border-slate-800/50 flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-white tracking-tight">Admin Lead</h2>
                                ...
                                <div key={index}>
                                    <Link
                                        ...
                                        className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group relative overflow-hidden ${isActive
                                            ? 'bg-gradient-to-r from-teal-600/20 to-emerald-600/10 text-teal-400 font-semibold'
                    ...
                    <div className="p-4 border-t border-slate-800/50 bg-slate-950/50 backdrop-blur-sm">
                        <div className="flex items-center gap-3 rounded-lg p-2 hover:bg-slate-900 transition-colors cursor-pointer">
                            ...
                            <div className="overflow-hidden">
                                <p className="text-sm font-medium text-white truncate">Admin Lead</p>
                                <p className="text-xs text-slate-500 truncate">leader@admin</p>
                            </div>
                        </div>
                    </div>
                </div>
