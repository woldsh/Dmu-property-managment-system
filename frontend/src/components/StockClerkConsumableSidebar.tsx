...
export default function StockClerkConsumableSidebar() {
    const pathname = usePathname();
    const basePath = '/procurement-management/stock-clerk/consumable-material';
            ...
            `}>
                <div className="w-72 flex flex-col h-full flex-shrink-0">
                    ...
                    <div className="p-6 border-b border-slate-800/50 flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-500 to-teal-500 flex items-center justify-center shadow-lg shadow-cyan-500/20 text-white">
                            <FaClipboardList className="text-xl" />
                        </div>
                        <div>
                            <h2 className="text-lg font-bold text-white tracking-tight">Stock Clerk</h2>
                            <p className="text-xs font-medium text-teal-400 uppercase tracking-wider">Consumables</p>
                        </div>
                    </div>
                                ...
                                <div key={index}>
                                    <Link
                                        ...
                                        className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group relative overflow-hidden ${isActive
                                            ? 'bg-gradient-to-r from-cyan-600/20 to-teal-600/10 text-cyan-400 font-semibold'
