                                        ...
                                        <div className="relative">
                                            ...
                                            <div className="p-4 space-y-1">
                                                ...
                                                <Link
                                                    ...
                                                    onClick={() => setIsProfileOpen(false)}
                                                    className="w-full flex items-center gap-4 px-5 py-4 rounded-3xl text-slate-600 hover:bg-gradient-to-r hover:from-white hover:to-purple-50/50 hover:text-purple-600 hover:shadow-xl hover:shadow-purple-500/5 transition-all duration-300 font-black text-sm group"
                                                >
                                                    <div className="w-10 h-10 rounded-2xl bg-slate-50 flex items-center justify-center group-hover:bg-white group-hover:shadow-md transition-all">
                                                        <FiSettings className="text-lg text-slate-400 group-hover:text-purple-500" />
                                                    </div>
                                                    <span className="tracking-tight">Manage Account</span>
                                                </Link>
                                            </div>
