...
export default function TeacherSidebar() {
    ...
    const menuItems = [
        ...
        { label: t('ac_decisions'), href: `${basePath}/ac-decision`, icon: FiClock },
    ];
                        ...
                        <div className="relative flex items-center gap-4">
                            ...
                            <div className="flex flex-col relative">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <p className="text-[9px] font-black text-blue-600/60 uppercase tracking-[0.4em] font-mono">{t('academic_staff')}</p>
                                </div>
                            </div>
                        </div>
                    </div>
