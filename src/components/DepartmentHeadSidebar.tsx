...
import { FaChartPie, FaClipboardList, FaEnvelope, FaCheckCircle, FaVideo, FaUserTie, FaTruckLoading, FaUndo, FaCar, FaFileAlt, FaExchangeAlt, FaCog, FaBuilding, FaClock } from 'react-icons/fa';
